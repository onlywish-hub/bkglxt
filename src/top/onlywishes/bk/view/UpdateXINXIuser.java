...
public class  UpdateXINXIuser extends JDialog {
	...
	public static void main(String[] args) {
		try {
			UpdateXINXIuser dialog = new UpdateXINXIuser();
	 ...
	 * @param userName 
	 */
	public UpdateXINXIuser() {
		showComponent();

	}

	public UpdateXINXIuser(String user_name) {
		showComponent();
	...
	public void showComponent() {
		...
		// 给窗体设置图标
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(UpdateXINXIuser.class.getResource("/top/picture/fox.png")));
